...
@Component({
  selector: 'app-scroll-parallax',
  templateUrl: './scroll-parallax.component.html',
  styleUrls: ['./scroll-parallax.component.css']
})
export class ScrollParallaxComponent implements OnInit {

  constructor() { }

  ngOnInit(): void {
    this.jsHillsFunction();
  }
